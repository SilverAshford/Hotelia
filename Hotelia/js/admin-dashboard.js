...
function buildPendingRow(b) {
    ...
    return `
        <tr id="booking-row-${b.id}">
            <td class="px-3 fw-bold text-muted">#BK-${b.id}</td>
            ...
            <td class="px-2">
                <div class="d-flex justify-content-end flex-wrap gap-1">
                    <button class="btn btn-sm btn-confirm" data-action="confirm" data-id="${b.id}">
                        <i class="fa-solid fa-check"></i><span class="d-none d-lg-inline ms-1">Confirm</span>
                    </button>
                    <button class="btn btn-sm btn-reject" data-action="reject" data-id="${b.id}">
                        <i class="fa-solid fa-xmark"></i><span class="d-none d-lg-inline ms-1">Reject</span>
                    </button>
...
function buildAllBookingRow(b) {
    ...
    if (status === 'pending') {
        actions = `
            <div class="d-flex justify-content-end flex-wrap gap-1">
                <button class="btn btn-sm btn-confirm" data-action="confirm" data-id="${b.id}" title="Confirm">
                    <i class="fa-solid fa-check"></i>
                </button>
                <button class="btn btn-sm btn-reject" data-action="reject" data-id="${b.id}" title="Reject">
        ...
        actions = `
            <div class="d-flex justify-content-end flex-wrap gap-1">
                <button class="btn btn-sm btn-outline-primary" data-action="complete" data-id="${b.id}" title="Mark Completed">
